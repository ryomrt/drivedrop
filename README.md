...
<img width="409" height="875" alt="app" src="https://github.com/user-attachments/assets/494f219b-4e3c-4140-abe8-7f7a830b5aa8" />
...
## ⚠️ セキュリティと制約事項、利用上の注意（必ずお読みください）
...
4. **アップロードした写真の削除について**
* アップロードした写真は、**このシステム上では削除できません。**
* 削除が必要な場合は、ドライブ上で削除する必要があります。
* 参加者が誤ってアップロードした写真や、不適切な写真があった場合は、参加者からドライブの管理者に連絡して削除してもらう、といった運用を検討してください。


5. **Google Apps Script の実行時間制限**
* Google Apps Script には実行時間制限があります。
* そのため、一度に大量の写真をアップロードすると、エラーが発生する可能性があります。
* システムでは、一度にアップロードする枚数の制限を設定できるようになっています。適宜調整してください。
...
<img width="517" height="470" alt="qr" src="https://github.com/user-attachments/assets/e1f2c4fa-f86a-4e7d-be9b-6f56a36347b7" />
...
本システムはGeminiと一緒に作りました。カスタマイズ方法やエラーの解決方法がわからない時は、ぜひ [Gemini](https://gemini.google.com/) にコードを貼り付けて質問してみてください！
